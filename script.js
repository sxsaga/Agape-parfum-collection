...
notificacion.style.cssText = position: fixed; top: 20px; right: 20px; background-color: #8D6E63; color: #FFF8E1; padding: 15px 25px; border-radius: 5px; z-index: 10000; box-shadow: 0 5px 15px rgba(0,0,0,0.2); animation: slideIn 0.3s ease; border: 1px solid #D7CCC8; font-weight: 500;;
